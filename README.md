...
![image alt](https://github.com/supriya554/Heart-failure-clinical-records--TABLAEU/blob/main/Dashboard%20imges/age-time%20survival%20status.png) 
7. **KPIs**: Total patients, deaths, males, females, and average age.  
